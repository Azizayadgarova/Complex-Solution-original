...
const Projects = () => {
  ...
  }, [i18n.language]); // 👈 til o‘zgarganda qayta fetch qiladi
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 bg-white">
      <div className="text-center mb-16">
        <h2 className="text-4xl sm:text-5xl font-extrabold text-[#1A2B5B] uppercase tracking-wide">{t('projects_title')}</h2>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8  justify-items-center">
        {projects.map((project) => (
          ...
          >
            ...
            <div className="p-6 bg-white">
              <p className='text-[20px] mb-[20px] font-bold'>{project.advantages}</p>
              ...
              <a
                ...
                className="absolute bottom-4 right-4 w-12 h-12 flex items-center justify-center rounded-full
                           ...
                           hover:scale-111 hover:shadow-lg"
                style={{
        ...
        {projects.length === 0 && (
          <p className="text-center w-full text-gray-600 text-xl md:col-span-2">
