  ...
  return (
    <motion.div
      ...
      className="relative bg-white rounded-2xl border border-gray-200 shadow-lg p-6 
                 ...
                 hover:shadow-xl hover:border-[#2a5e91] transform hover:-translate-y-1 transition duration-300 ease-in-out" // Rang va border rangi Advantage5 ga moslashtirildi
    >
      {/* Raqam */}
      ...
      {/* Ikonka */}
      <div className="bg-[#2a5e91] p-3 rounded-full shadow-md mb-4 relative z-10 flex items-center justify-center"> {/* Fon rangi Advantage5 ga moslashtirildi */}
      ...
      <h3 className="text-[#1C3B6F] font-bold text-xl sm:text-2xl mb-3 relative z-10">
        {title}
        <span className="block h-0.5 w-12 bg-[#4CAF50] mt-2"></span> {/* Chiziq rangi Advantage5 ga moslashtirildi */}
      </h3>
